...
const BLOBS: Blob[] = [
  { color: "rgba(142, 100, 255,0.42)", size: "52vw", left: "2%", top: "-14%", x: [0, 120, -40, 0], y: [0, 60, 120, 0], scale: [1, 1.15, 0.95, 1], duration: 22 },
  { color: "rgba(115, 54, 255,0.34)", size: "46vw", left: "54%", top: "6%", x: [0, -110, 60, 0], y: [0, 80, -30, 0], scale: [1.05, 0.9, 1.2, 1.05], duration: 27 },
    ...
    <div aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      <motion.div
        ...
        style={{
          ...
          marginTop: "-75vmax",
          background:
            "conic-gradient(from 0deg, rgba(142, 100, 255,0.14), rgba(120,178,255,0.06), rgba(255,196,132,0.05), rgba(115, 54, 255,0.14), rgba(142, 100, 255,0.14))",
          filter: "blur(50px)",
