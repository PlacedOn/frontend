...
const BLOBS: Blob[] = [
  { color: "rgba(16,16,18,0.05)", size: "60%", x: ["6%", "44%", "18%", "58%", "6%"], y: ["-16%", "12%", "40%", "-12%", "-16%"], scale: [1, 1.24, 0.88, 1.14, 1], duration: 13 },
  { color: "rgba(16,16,18,0.045)", size: "54%", x: ["58%", "20%", "78%", "38%", "58%"], y: ["54%", "18%", "52%", "76%", "54%"], scale: [1.1, 0.82, 1.3, 0.92, 1.1], duration: 15 },
  { color: "rgba(16,16,18,0.04)", size: "48%", x: ["78%", "32%", "64%", "12%", "78%"], y: ["-8%", "30%", "66%", "40%", "-8%"], scale: [0.9, 1.3, 1, 1.18, 0.9], duration: 14 },
  { color: "rgba(16,16,18,0.035)", size: "44%", x: ["28%", "68%", "8%", "50%", "28%"], y: ["66%", "8%", "28%", "60%", "66%"], scale: [1, 1.14, 0.82, 1.24, 1], duration: 16 },
  { color: "rgba(16,16,18,0.03)", size: "62%", x: ["48%", "10%", "70%", "28%", "48%"], y: ["30%", "60%", "-10%", "50%", "30%"], scale: [1.24, 0.88, 1.14, 0.86, 1.24], duration: 11 },
];
