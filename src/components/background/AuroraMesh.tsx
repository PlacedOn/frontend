...
const BLOBS: Blob[] = [
  ...
  { color: "rgba(171, 149, 255,0.24)", size: "48%", x: ["78%", "32%", "64%", "12%", "78%"], y: ["-8%", "30%", "66%", "40%", "-8%"], scale: [0.9, 1.3, 1, 1.18, 0.9], duration: 14 },
  { color: "rgba(203, 193, 255,0.24)", size: "44%", x: ["28%", "68%", "8%", "50%", "28%"], y: ["66%", "8%", "28%", "60%", "66%"], scale: [1, 1.14, 0.82, 1.24, 1], duration: 16 },
  { color: "rgba(203, 193, 255,0.15)", size: "62%", x: ["48%", "10%", "70%", "28%", "48%"], y: ["30%", "60%", "-10%", "50%", "30%"], scale: [1.24, 0.88, 1.14, 0.86, 1.24], duration: 11 },
];
