  ...
  return (
    <div aria-hidden className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 90% at 50% 22%, #E7E2FF 0%, rgba(231,226,255,0) 55%), radial-gradient(90% 70% at 78% 30%, rgba(142, 100, 255,0.28), transparent 60%), radial-gradient(80% 70% at 20% 40%, rgba(115, 54, 255,0.20), transparent 60%), var(--porcelain)",
        }}
      />
