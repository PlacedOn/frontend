...
const vec3 LIFT  = vec3(0.129, 0.122, 0.110);   // #211F1C — where light falls
...
void main() {
  ...
  light = smoothstep(0.28, 0.92, light);

  // Fine tooth so the surface is a material, not a gradient.
  float tooth = (fbm(p * 7.0 - t * 0.4) - 0.5) * 0.16;

  vec3 col = mix(INK, LIFT, clamp(light * 0.85 + tooth, 0.0, 1.0));
