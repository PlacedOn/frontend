...
const BEAMS = [
  { top: "-25%", left: "6%", w: 200, color: "rgba(142, 100, 255,0.40)", dur: 5.5, delay: 0 },
  { top: "-25%", left: "34%", w: 160, color: "rgba(120,178,255,0.34)", dur: 6.5, delay: 1.8 },
  { top: "-25%", left: "62%", w: 240, color: "rgba(115, 54, 255,0.38)", dur: 6, delay: 3.4 },
];
  ...
  return (
    <div ref={root} aria-hidden className="pointer-events-none fixed inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(115deg, rgba(142, 100, 255,0.30), rgba(120,178,255,0.20) 28%, rgba(255,196,132,0.14) 50%, rgba(115, 54, 255,0.28) 72%, rgba(142, 100, 255,0.30))",
      ...
      {METEORS.map((m, i) => (
        <span
          ...
          style={{
            top: m.top,
            left: m.left,
            background: "linear-gradient(90deg, #ffffff, rgba(142, 100, 255,0.9) 26%, transparent)",
            boxShadow: "0 0 14px rgba(142, 100, 255,0.85)",
            willChange: "transform, opacity",
          }}
        />
      ))}
