    ...
    >
      <div className="relative flex w-full max-w-[var(--max)] items-center gap-4 px-6">
        ...
        <motion.span
          ...
          style={{ background: "linear-gradient(90deg, transparent, color-mix(in oklab, var(--iris-soft) 50%, transparent))" }}
        ...
        <motion.span
          ...
          style={{ fontFamily: "var(--font-mono)", background: "rgba(255,255,255,0.06)", border: "1px solid color-mix(in oklab, var(--iris-soft) 30%, transparent)", backdropFilter: "blur(6px)" }}
        ...
        <motion.span
          ...
          style={{ background: "linear-gradient(90deg, color-mix(in oklab, var(--iris-soft) 50%, transparent), transparent)" }}
          initial={reduce ? { opacity: 1 } : { scaleX: 0 }}
          whileInView={{ scaleX: 1 }}
          viewport={{ once: true, margin: "-20%" }}
          transition={{ duration: reduce ? 0 : 0.62, ease: EASE_OUT }}
