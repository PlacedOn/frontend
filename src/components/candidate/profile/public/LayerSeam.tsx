    ...
    >
      <div className="relative flex w-full max-w-[var(--max)] items-center gap-4 px-6">
        ...
        <motion.span
          ...
          style={{ background: "linear-gradient(90deg, transparent, rgba(142, 100, 255,0.5))" }}
        ...
        <motion.span
          ...
          style={{ fontFamily: "var(--font-mono)", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(142, 100, 255,0.3)", }}
        ...
        <motion.span
          ...
          style={{ background: "linear-gradient(90deg, rgba(142, 100, 255,0.5), transparent)" }}
          initial={reduce ? { opacity: 1 } : { scaleX: 0 }}
          whileInView={{ scaleX: 1 }}
          viewport={{ once: true, margin: "-20%" }}
          transition={{ duration: reduce ? 0 : 0.62, ease: EASE_OUT }}
