  ...
  return (
    <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-6">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(16,16,18,0.05), rgba(16,16,18,0.02))",
      ...
      >
        <span
          ...
          style={{ background: "radial-gradient(circle, rgba(16,16,18,0.10), transparent 68%)", filter: "blur(8px)" }}
        />
