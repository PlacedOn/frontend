  ...
  return (
    <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-6">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(142, 100, 255,0.10), rgba(115, 54, 255,0.04))",
      ...
      >
        <span
          ...
          style={{ background: "radial-gradient(circle, rgba(142, 100, 255,0.20), transparent 68%)", filter: "blur(8px)" }}
        />
