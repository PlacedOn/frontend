  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div
        ...
        style={{ background: "radial-gradient(120% 90% at 50% 6%, #1B1B1E 0%, #111113 44%, #0A0A0B 100%)" }}
      />
      {/* violet nebula */}
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 h-[620px] w-[620px] -translate-x-1/2 -translate-y-1/2 rounded-full"
        style={{ background: "radial-gradient(circle, rgba(220,220,225,0.14), transparent 62%)", filter: "blur(30px)" }}
      />
      ...
      <div className="relative z-[1] mx-auto flex max-w-3xl flex-col items-center px-6 text-center">
        <Reveal className="flex flex-col items-center">
          <p className="text-[12px] font-semibold uppercase tracking-[0.22em]" style={{ fontFamily: "var(--font-mono)", color: "rgba(190,190,196,0.9)" }}>
          ...
          >
            Interview anyone,{" "}
            <span style={{ background: "linear-gradient(90deg,#EDEDEF,#B6B6BA)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}>
              anywhere
            </span>
            .
          </h2>
      ...
      <div className="relative z-[1] mx-auto mt-6 w-[min(92vw,560px)]">
        <div className="relative aspect-square w-full">
          ...
          <span
            ...
            style={{ border: "1px solid rgba(255,255,255,0.16)", boxShadow: "inset 0 0 70px rgba(255,255,255,0.06)" }}
          />
