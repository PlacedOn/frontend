 ...
 *
 * The work side goes to the interview, because there is no public job board on
 * this branch. If /jobs is ever brought back, point it there instead — asking a
 * stranger for 22 minutes before showing them a single role is asking for the
 * sale before showing the product.
 *
...
export function TwoSidedSearch() {
