...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"m9 12 2 2 4-4"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
