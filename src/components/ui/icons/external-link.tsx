...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"M15 3h6v6"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"M10 14 21 3"} variants={variants.e1} initial="initial" animate={controls} />
      <motion.path d={"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"} variants={variants.e2} initial="initial" animate={controls} />
    </motion.svg>
  );
}
