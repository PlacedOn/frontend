...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.circle cx={"12"} cy={"12"} r={"3"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
