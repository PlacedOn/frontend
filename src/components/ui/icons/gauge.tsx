...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"m12 14 4-4"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"M3.34 19a10 10 0 1 1 17.32 0"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
