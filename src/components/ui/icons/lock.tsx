...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.rect width={"18"} height={"11"} x={"3"} y={"11"} rx={"2"} ry={"2"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"M7 11V7a5 5 0 0 1 10 0v4"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
