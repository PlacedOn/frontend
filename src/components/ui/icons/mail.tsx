...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.rect x={"2"} y={"4"} width={"20"} height={"16"} rx={"2"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
