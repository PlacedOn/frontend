...
function IconComponent({ size = 24, ...props }: MessageSquareTextProps) {
    ...
    >
      <motion.g variants={variants.group} initial="initial" animate={controls}>
        <motion.path
          ...
          animate={controls}
        />
        <motion.path d="M13 8H7" variants={variants.path2} initial="initial" animate={controls} />
        <motion.path d="M17 12H7" variants={variants.path3} initial="initial" animate={controls} />
      </motion.g>
    </motion.svg>
  );
}

export function MessageSquareText(props: MessageSquareTextProps) {
