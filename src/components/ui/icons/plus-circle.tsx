...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.circle cx={"12"} cy={"12"} r={"10"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"M8 12h8"} variants={variants.e1} initial="initial" animate={controls} />
      <motion.path d={"M12 8v8"} variants={variants.e2} initial="initial" animate={controls} />
    </motion.svg>
  );
}
