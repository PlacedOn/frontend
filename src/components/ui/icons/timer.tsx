...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.line x1={"10"} x2={"14"} y1={"2"} y2={"2"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.line x1={"12"} x2={"15"} y1={"14"} y2={"11"} variants={variants.e1} initial="initial" animate={controls} />
      <motion.circle cx={"12"} cy={"14"} r={"8"} variants={variants.e2} initial="initial" animate={controls} />
    </motion.svg>
  );
}
