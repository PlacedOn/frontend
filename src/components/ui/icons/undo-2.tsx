...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"M9 14 4 9l5-5"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}

export function Undo2(props: Props) {
