...
function IconComponent({ size = 24, ...props }: Props) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d={"M18 6 6 18"} variants={variants.e0} initial="initial" animate={controls} />
      <motion.path d={"m6 6 12 12"} variants={variants.e1} initial="initial" animate={controls} />
    </motion.svg>
  );
}
